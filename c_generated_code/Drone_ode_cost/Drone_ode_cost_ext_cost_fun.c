...
/* Drone_ode_cost_ext_cost_fun:(i0[11],i1[4],i2[0],i3[15])->(o0) */
...
CASADI_SYMBOL_EXPORT int Drone_ode_cost_ext_cost_fun_work_bytes(casadi_int *sz_arg, casadi_int* sz_res, casadi_int *sz_iw, casadi_int *sz_w) {
